...
var testCases = []struct {
	...
	{[]string{"     AkjhZ zLKIJz , 23y"}},
	{[]string{""}},
	{random.StrSlice(chars.Words)},  // Add random word cases

	// Additional multi-argument cases
	{[]string{"rostring"}},
	{[]string{"rostring", "this", "is"}},
	{[]string{"rostring", "not", "good", "for  you"}},
}
